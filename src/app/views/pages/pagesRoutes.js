...
const CustomerForm = Loadable(lazy(() => import("./customers/CustomerForm")));
...
const pagesRoutes = [
  ...
  { path: "/pages/Existing-Jobs", element: <CustomerList /> },
  { path: "/pages/new-jobRequest", element: <CustomerForm /> },
  { path: "/pages/Request-Details", element: <CustomerViewer /> },
